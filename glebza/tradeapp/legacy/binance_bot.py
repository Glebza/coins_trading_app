"""Live Binance spot bot (legacy). Run from repo root with tradeapp/src on PYTHONPATH."""
...
from glebza.tradeapp.src.exchanges.exchange import Exchange
...
ws = websocket.WebSocketApp(SOCKET, on_message=handle_socket_message, on_error=on_error, on_close=on_close)
ws.run_forever()
